...
if ($mod == "del") {
	$q_del = mysql_query("DELETE FROM tbl_vm WHERE no_vm = '$id_del'");
...
<div class="row">
<div class="col-xs-12">
<h3 class="header smaller lighter blue">Historis Aktifasi VM</h3>
...
<tr>
	...
	<th class="hidden-480">Tanggal Aktivasi</th>
...
<tbody>
<?php
$view=mysql_query("select * from tbl_vm where status=1 order by status desc");
...
<td><img src="<?php echo $row['1'];?> "width="120" height="120"></td>
	
	<td><?php echo strtoupper($row['4']);?>,  <?php echo $row['2'];?>.<?php echo $row['3'];?></td>

	<td><?php echo tgl_indo($row['6']);?></td>

	<td class="hidden-480">
		<span><?php echo tgl_indo($row['7']);?></span>
	</td>
