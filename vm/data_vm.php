...
<div class="row">
<div class="col-xs-12">
<h3 class="header smaller lighter blue">Data Vending Machine</h3>
...
<tbody>
<?php
$view=mysql_query("select * from tbl_vm order by status desc");
...
<tr>
	...
	<td class="hidden-phone"><?php echo $row['4'];?></td>
...
<td class="hidden-480"><?php echo status($row['5']);?></td>
	<td>
