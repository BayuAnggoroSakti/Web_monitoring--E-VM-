...
<head>
	...
	<meta charset="utf-8" />
	<title>Login - PT AINO INDONESIA (E-VM)</title>
...
<body class="login-layout light-login" OnLoad="document.login.username.focus();">
...
<div class="position-relative">
	<div id="login-box" class="login-box visible widget-box no-border" style="margin-top:120px;margin-bottom:20px">
